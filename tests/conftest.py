...
def test_params():
    ...
    "epoch_count": 1,
    "chunk_count": 9,
    "experiment_log_message_count": 1,
    "subject_enter_exit_count": 1,
    "subject_weight_time_count": 1
    }        
...
@pytest.fixture
def epoch_chunk_ingestion(test_params, pipeline):
    acquisition = pipeline["acquisition"]
    ...
    acquisition.Epoch.ingest_epochs(
        ...
        start=test_params["start_ts"], end=test_params["end_ts"]
    )
