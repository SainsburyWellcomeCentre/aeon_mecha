...
class VideoSourcePosition(dj.Imported):
    ...
    _stream_detail = {
        ...
        "stream_reader": "aeon.io.reader.Position",
        "stream_reader_kwargs": {"pattern": "{pattern}_200_*"},
        "stream_description": "",
        "stream_hash": UUID("d7727726-1f52-78e1-1355-b863350b6d03"),
    }
    ...
    def key_source(self):
        ...
        """
        return (
            acquisition.Chunk * VideoSource.join(VideoSource.RemovalTime, left=True)
    ...
    def make(self, key):
        ...
        device_name = (VideoSource & key).fetch1("video_source_name")
...
class VideoSourceRegion(dj.Imported):
    ...
    _stream_detail = {
        "stream_type": "Region",
        "stream_reader": "aeon.schema.foraging._RegionReader",
        "stream_reader_kwargs": {"pattern": "{pattern}_201_*"},
        "stream_description": "",
        "stream_hash": UUID("6c78b3ac-ffff-e2ab-c446-03e3adf4d80a"),
    }
...
class VideoSourceVideo(dj.Imported):
    ...
    _stream_detail = {
        "stream_type": "Video",
        "stream_reader": "aeon.io.reader.Video",
        "stream_reader_kwargs": {"pattern": "{pattern}_*"},
        "stream_description": "",
        "stream_hash": UUID("f51c6174-e0c4-a888-3a9d-6f97fb6a019b"),
    }
...
class SpinnakerVideoSourcePosition(dj.Imported):
        definition = """  # Raw per-chunk Position data stream from SpinnakerVideoSource (auto-generated with aeon_mecha-unknown)
...
@schema 
class SpinnakerVideoSourceRegion(dj.Imported):
        definition = """  # Raw per-chunk Region data stream from SpinnakerVideoSource (auto-generated with aeon_mecha-unknown)
    -> SpinnakerVideoSource
    -> acquisition.Chunk
    ---
    sample_count: int      # number of data points acquired from this stream for a given chunk
...
class WeightScaleWeightFiltered(dj.Imported):
    ...
    stable: longblob
    """
        _stream_reader = aeon.schema.foraging._Weight
        _stream_detail = {'stream_type': 'WeightFiltered', 'stream_reader': 'aeon.schema.foraging._Weight', 'stream_reader_kwargs': {'pattern': '{pattern}_202_*'}, 'stream_description': '', 'stream_hash': UUID('912fe1d4-991c-54a8-a7a7-5b96f5ffca91')}
...
class WeightScaleWeightRaw(dj.Imported):
    ...
    """
        _stream_reader = aeon.schema.foraging._Weight
        _stream_detail = {'stream_type': 'WeightRaw', 'stream_reader': 'aeon.schema.foraging._Weight', 'stream_reader_kwargs': {'pattern': '{pattern}_200_*'}, 'stream_description': '', 'stream_hash': UUID('f5ab9451-7104-2daf-0aa2-d16abb3974ad')}
...
class WeightScaleWeightSubject(dj.Imported):
        definition = """  # Raw per-chunk WeightSubject data stream from WeightScale (auto-generated with aeon_mecha-unknown)
    -> WeightScale
    -> acquisition.Chunk
    ---
    sample_count: int      # number of data points acquired from this stream for a given chunk
    ...
    """
        _stream_reader = aeon.schema.foraging._Weight
        _stream_detail = {'stream_type': 'WeightSubject', 'stream_reader': 'aeon.schema.foraging._Weight', 'stream_reader_kwargs': {'pattern': '{pattern}_204_*'}, 'stream_description': '', 'stream_hash': UUID('01f51299-5709-9e03-b415-3d92a6499202')}
