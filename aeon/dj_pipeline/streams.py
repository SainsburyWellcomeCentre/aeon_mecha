...
class UndergroundFeederBeamBreak(dj.Imported):
    ...
    _stream_detail = {
        ...
        "stream_reader": "aeon.io.reader.BitmaskEvent",
        "stream_reader_kwargs": {"pattern": "{pattern}_32_*", "value": 34, "tag": "PelletDetected"},
        "stream_description": "",
        "stream_hash": UUID("ab975afc-c88d-2b66-d22b-65649b0ea5f0"),
    }
...
class UndergroundFeederDeliverPellet(dj.Imported):
    ...
    _stream_detail = {
        ...
        "stream_reader": "aeon.io.reader.BitmaskEvent",
        "stream_reader_kwargs": {"pattern": "{pattern}_35_*", "value": 128, "tag": "TriggerPellet"},
        "stream_description": "",
        "stream_hash": UUID("09099227-ab3c-1f71-239e-4c6f017de1fd"),
    }
...
class UndergroundFeederDepletionState(dj.Imported):
    ...
    _stream_detail = {
        "stream_type": "DepletionState",
        "stream_reader": "aeon.io.reader.Csv",
        "stream_reader_kwargs": {
            "pattern": "{pattern}_*",
            "columns": ["threshold", "offset", "rate"],
            "extension": "csv",
            "dtype": None,
        },
        "stream_description": "",
        "stream_hash": UUID("a944b719-c723-08f8-b695-7be616e57bd5"),
    }
...
class UndergroundFeederEncoder(dj.Imported):
    ...
    _stream_detail = {
        "stream_type": "Encoder",
        "stream_reader": "aeon.io.reader.Encoder",
        "stream_reader_kwargs": {"pattern": "{pattern}_90_*"},
        "stream_description": "",
        "stream_hash": UUID("f96b0b26-26f6-5ff6-b3c7-5aa5adc00c1a"),
    }
...
class UndergroundFeederManualDelivery(dj.Imported):
    ...
    _stream_detail = {
        "stream_type": "ManualDelivery",
        "stream_reader": "aeon.io.reader.Harp",
        "stream_reader_kwargs": {
            "pattern": "{pattern}_*",
        ...
        "stream_description": "",
        "stream_hash": UUID("98ce23d4-01c5-a848-dd6b-8b284c323fb0"),
    }
...
class UndergroundFeederMissedPellet(dj.Imported):
    ...
    _stream_detail = {
        ...
        "stream_description": "",
        "stream_hash": UUID("2fa12bbc-3207-dddc-f6ee-b79c55b6d9a2"),
    }
...
class UndergroundFeederRetriedDelivery(dj.Imported):
    ...
    _stream_detail = {
        ...
        "stream_reader_kwargs": {
            "pattern": "{pattern}_*",
            "columns": ["retried_delivery"],
            "extension": "bin",
        },
        "stream_description": "",
        "stream_hash": UUID("62f23eab-4469-5740-dfa0-6f1aa754de8e"),
    }
...
class WeightScaleWeightFiltered(dj.Imported):
    ...
    _stream_detail = {
        ...
        "stream_reader": "aeon.io.reader.Harp",
        "stream_reader_kwargs": {
            "pattern": "{pattern}_202_*",
            "columns": ["weight(g)", "stability"],
            "extension": "bin",
        },
        "stream_description": "",
        "stream_hash": UUID("64ee6b2f-508a-c9c9-edcb-ffdfd6b58dbe"),
    }
...
class WeightScaleWeightRaw(dj.Imported):
    ...
    _stream_detail = {
        ...
        "stream_reader": "aeon.io.reader.Harp",
        "stream_reader_kwargs": {
            "pattern": "{pattern}_200_*",
            "columns": ["weight(g)", "stability"],
            "extension": "bin",
        },
        "stream_description": "",
        "stream_hash": UUID("7068a927-818f-54f5-48c8-fd06295caa5a"),
    }
...
class RfidReaderRfidEvents(dj.Imported):
    ...
    _stream_reader = aeon.io.reader.Harp
    _stream_detail = {
        "stream_type": "RfidEvents",
        "stream_reader": "aeon.io.reader.Harp",
        "stream_reader_kwargs": {"pattern": "{pattern}Events_*", "columns": ["rfid"], "extension": "bin"},
        "stream_description": "",
        "stream_hash": UUID("1e02e76a-6340-1748-4704-e1b11288b7d3"),
    }
