...
def get_video_frames(
    experiment_name, device, start=None, end=None, time=None, tolerance=None, plot=True
):
    """
    ...
    if plot:
        ...
        fig, axes = plt.subplots(
            int(np.ceil(len(video_frames) / col_count)), col_count, figsize=(16, 8)
        )
