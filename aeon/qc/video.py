...
for device in devicenames:
    ...
    for key, period in videochunks.groupby(by="epoch"):
        ...
        for chunk in period.itertuples():
            ...
            print(f"[{key}] Analysing {device} {chunk.Index}... ", end="")
            ...
            print(
                "drops: {} frameOffset: {}  maxHarpDelta: {} s  maxCameraDelta: {} s".format(
                    drop_count - frame_offset, drop_count, max_harp_delta, max_camera_delta
                )
            )
