...
def main(argv):
    ...
    parser.add_argument("--fig_filename_pattern", help="figure filename pattern", default="../../figures/travelled_distance_diffsPatch1MinusPatch2.{:s}")
    ...
    # for mouse_id in mouse_ids[:2]:
        ...
        # for i in range(2):
            ...
            ma_travelled_distance1 = aeon.query.utils.get_moving_average(x=travelled_distance1, window_len_sec=600, frequency='5s', start=start, end=end, smooth='120s', center=True)
            ...
            ma_travelled_distance2 = aeon.query.utils.get_moving_average(x=travelled_distance2, window_len_sec=600, frequency='5s', start=start, end=end, smooth='120s', center=True)
            rateDiff = ma_travelled_distance2-ma_travelled_distance1
    ...
    fig = px.imshow(img=rateDiffs_matrix,
                    ...
                    labels=dict(color="Travelled Distance (cm)<br>Patch2-Patch1"))
    fig.update_layout(
