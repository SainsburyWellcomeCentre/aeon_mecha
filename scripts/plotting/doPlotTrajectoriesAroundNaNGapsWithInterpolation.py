...
def main(argv):
    ...
    parser.add_argument("--max_points", help="Maximum number of points to plot", default=750000, type=int)
    ...
    parser.add_argument("--fig_filename_pattern", help="figure filename pattern", default="../../figures/trajectories_aroundNaNs_withInterpolated_session{:d}_start{:.02f}_end{:.02f}.{:s}")
    ...
    for i in range(30):
        ...
        fig.add_trace(trace_around_nan_interpolated)
