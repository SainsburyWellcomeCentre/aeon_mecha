...
def main(argv):
    ...
    parser.add_argument("--fig_filename_pattern", help="figure filename pattern", default="../../figures/cum_travelled_distance_diffsChangedMinusNotChanged.{:s}")
...
#                 changed_travelled_distance = changed_cum_travelled_distance.diff()
                changed_ma_cum_travelled_distance = aeon.query.utils.get_moving_average(x=changed_cum_travelled_distance, window_len_sec=600, frequency='5s', start=start, end=end, smooth='120s', center=True)
...
#                 not_changed_travelled_distance = not_changed_cum_travelled_distance.diff()
                not_changed_ma_cum_travelled_distance = aeon.query.utils.get_moving_average(x=not_changed_cum_travelled_distance, window_len_sec=600, frequency='5s', start=start, end=end, smooth='120s', center=True)
...
#                 not_changed_patch_rate = aeon.query.utils.get_events_rates(events=not_changed_patch_pellets, window_len_sec=600, frequency='5s', start=start, end=end, smooth='120s')
                rateDiff = changed_ma_cum_travelled_distance-not_changed_ma_cum_travelled_distance
    ...
    fig = px.imshow(img=rateDiffs_matrix,
                    ...
                    color_continuous_scale='PIYG', labels=dict(color="Cum Travelled Dist (cm)<br>Changed-Not Changed<br>Patch"))
