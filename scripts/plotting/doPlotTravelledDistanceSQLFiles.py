...
def main(argv):
    ...
    parser.add_argument("--title_pattern", help="title pattern",
                        default="session_start_time={:s}, start_secs={:.02f}, duration_secs={:02f}, sample_rate={:.02f}, storage={:s}")
    parser.add_argument("--fig_filename_pattern", help="figure filename pattern",
                        default="../../figures/travelled_distance_sessionStart{:s}_startSecs_{:02f}_durationSecs_{:02f}_srate{:.02f}_storage{:s}.{:s}")
    ...
    title = title_pattern.format(session_start_time_str, start_secs, duration_secs, plot_sample_rate, storageMgr_type)
    fig = go.Figure()
