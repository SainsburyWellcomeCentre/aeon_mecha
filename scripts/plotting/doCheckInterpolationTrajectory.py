...
def main(argv):
    ...
    title = title_pattern.format(str(metadata.index[session]), t0_relative, tf_relative, duration_sec, max_points, 1.0/(time_stamps_interpolated[1]-time_stamps_interpolated[0]))
    fig = go.Figure()
