...
def main(argv):
    ...
    parser.add_argument("--title_pattern", help="title pattern", default="session_start_time={:s}, start_secs={:.02f}, duration_secs={:02f}, sample_rate={:.02f} Hz, storage={:s}")
    ...
    title = title_pattern.format(session_start_time_str, start_secs, duration_secs, sample_rate, storageMgr_type)
    storageMgr_type = args.storageMgr_type
    fig = go.Figure()
